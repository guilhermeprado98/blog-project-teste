...
<div class="filtro" style="margin-top: 50px; margin-left: 30px;">
...
<div class="container container--narrow page-section" style="margin-left: 150px">
   <?php
while (have_posts()) {
    the_post();?>
   <div class="post-item">
      ...
      <div class="generic-content">
         <?php the_excerpt();?>
         <p><a class="btn btn--blue" href="<?php the_permalink();?>">Continue lendo</a></p>
      </div>
